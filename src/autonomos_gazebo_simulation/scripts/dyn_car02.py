...
spawn_req.model_name = "Dyn_car02"
spawn_req.model_xml  = open(pkg_path + '/models/Dyn_car02/model.sdf','r').read()
spawn_req.robot_namespace = ''
spawn_req.initial_pose.position.x = -12.93
spawn_req.initial_pose.position.y = -23.56
...
if __name__ == "__main__":
	...
	Vpub = rospy.Publisher("/Dyn_car02/manual_control/speed",    Int16, queue_size=15)	 
	Spub = rospy.Publisher("/Dyn_car02/manual_control/steering", Int16, queue_size=15)
	rospy.Subscriber("Dyn_car02/camera_obs/rgb/image_raw",Image,callback_V)	 						
	rospy.spin()
